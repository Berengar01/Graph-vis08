var app = (function() {
    ...
    function initEventHandler() {
        ...
        window.onkeydown = function(evt) {
            ...
            case('I'):
				angle += Math.PI / 36;
				illumination.light[0].position[0] = 0 + Math.cos(angle)*r;
				illumination.light[0].position[2] = 0 + Math.sin(angle)*r;
				
				angleNew = angle + Math.PI;
				illumination.light[1].position[0] = 0 + Math.cos(angleNew)*r;
				illumination.light[1].position[2] = 0 + Math.sin(angleNew)*r;
				break;
			case('L'):
				angle -= Math.PI / 36;
				illumination.light[1].position[0] = 0 - Math.cos(angle)*r;
				illumination.light[1].position[2] = 0 - Math.sin(angle)*r;
				
				angleNew = angle + Math.PI;
				illumination.light[0].position[0] = 0 - Math.cos(angleNew)*r;
				illumination.light[0].position[2] = 0 - Math.sin(angleNew)*r;
				break;
            }
